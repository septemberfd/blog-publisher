...
The GitHub-based blog publisher: [https://septemberfd.github.io/blog-publisher/](https://septemberfd.github.io/blog-publisher/)
...
Before using this publisher, I have to 

- manually converts the Google Doc into Markdown format
- manually uploads all the images to Strapi or somewhere else one by one
